          ...
          <div className="pt-5 pb-8">
            <div className="max-w-[650px] w-full grid grid-flow-row m-auto ">
              <h1 className="font-bold text-[26px]">
                Đăng ký nhận tin từ Sudes Phone
              </h1>
              <span className="text-base font-medium text-[#585858]">
              ...
              <form action="" className="relative mt-5">
                <input
                  ...
                  className="w-full border border-[#141414] rounded-full py-2 px-[30px] text-sm focus:outline-none"
                />
                <button className="absolute top-0 right-0 bg-black text-white px-6 h-[37px] rounded-full">
                  Đăng ký
                </button>
              </form>
            </div>
              ...
              <div className="grid grid-cols-12 grid-rows-1  text-start">
                <div className="col-span-4 pr-6">
                  <div className="mb-[15px]">
                    <a href="#" className="text-white">
                      <img src={logo} alt="" width={249} height={29} />
                    </a>
                  </div>
                  <div className="mb-[10px] text-base">
                    Hệ thống cửa hàng Sudes Phone chuyên bán lẻ điện thoại, máy
                    tính laptop, smartwatch, smarthome, phụ kiện chính hãng -
                    Giá tốt, giao miễn phí.
                  </div>
                  <div className=" text-base">
                    ...
                    <div className="py-1">
                      Số điện thoại:{" "}
                      <span className="hover:text-[#bf1e2e] cursor-pointer">
                        1900 6750
                      </span>
                    </div>
                    <div className="py-1">
                ...
                <div className="col-span-2 text-[15px]">
                  <ul>
                    ...
                    {ListChinhSach.conten.map((item, index) => (
                      <li
                        className="py-1 hover:text-[#bf1e2e] cursor-pointer leading-normal"
                        key={index}
                      >
                        <a href="#"></a>
                        {item}
                ...
                <div className="col-span-2 text-[15px]">
                  <ul>
                    ...
                    {ListHuongDan.conten.map((item, index) => (
                      <li
                        className="py-1 hover:text-[#bf1e2e] cursor-pointer leading-normal"
                        key={index}
                      >
                ...
                <div className="col-span-4">
                  ...
                  <div className="flex gap-3 mb-5">
                    <a href="">
                      <img src={facebook_2} alt="facebook" />
                    </a>
                    <a href="">
                  ...
                  <div className="col-span-4 ">
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="w-16">
                        <img src={payment_3} alt="payment_3" />
                      </div>
                      <div className="w-16">
                        <img src={payment_4} alt="payment_4" />
                      </div>
                      <div className="w-16">
                        <img src={payment_5} alt="payment_5" />
                      </div>
                    </div>
                    <div className="flex gap-2 mt-2">
                      <div className="w-16">
                        <img src={payment_6} alt="payment_6" />
                      </div>
                      <div className="w-16">
                        <img src={payment_7} alt="payment_7" />
                      </div>
                    </div>
                  </div>
                </div>
